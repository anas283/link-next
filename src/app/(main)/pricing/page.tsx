        ...
        <div className="bg-white dark:bg-gray-900">
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="flex flex-col md:flex-row justify-center gap-10">
              <div className="flex flex-col p-6 md:w-[380px] text-center text-gray-900 bg-white rounded-lg border-2 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
